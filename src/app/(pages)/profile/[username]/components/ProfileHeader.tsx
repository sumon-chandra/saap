        ...
        <div>
          <div className="relative space-y-6 md:space-y-0 md:flex items-center justify-between">
            ...
            <div className="md:text-right space-y-1">
              <h4 className="text-3xl font-semibold">{profile?.name}</h4>
              <small className="opacity-40">{profile?.userName}</small>
            ...
            <Link
              ...
              className="absolute right-0 top-0 rounded-3xl py-1 px-3 bg-saap-bg-primary-light text-xs text-saap-primary font-semibold dark:text-saap-text-dark-primary dark:bg-saap-bg-dark-secondary cursor-pointer select-none"
            >
              Edit profile
            </Link>
          </div>
